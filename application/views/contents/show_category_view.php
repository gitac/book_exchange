        ...
        <div id="main" class="shell">
            ...
            <div id="see_more" style="height: 1000px; width: 75%; margin-left: 25%;">
                ...
                <table style="width: 100%">
                    <?php for ($i = 0; $i < 40; $i++) { ?>
                        <tr>
                            <td style="width: 50%; padding-left: 5%; font-size: 16px"><ul><li><a href="<?php echo base_url() ?>index.php/category_books">ANTIQUES & COLLECTIBLES</a></li></ul></td>
                            <td style="width: 50%; padding-left: 5%; font-size: 16px"><ul><li><a href="<?php echo base_url() ?>index.php/category_books">ARCHITECTURE</a></li></ul></td>
                        </tr>
                    <?php } ?>
                </table>
            </div>
